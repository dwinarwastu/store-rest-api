...
export const createCategoryService = async (req) => {
    ...
    if (!createCategory)
        throw new InternalServerError("Failed create category");
...
export const updateCategoryService = async (req) => {
    ...
    if (!updateCategory)
        throw new InternalServerError("Failed update category");
...
export const deleteCategoryService = async (req) => {
    ...
    if (!deleteCategory)
        throw new InternalServerError("Failef delete category");
